...
export const Button = ({
  ...
  return (
    <button
      className={twMerge(
        'flex w-fit cursor-pointer items-center justify-center gap-1 rounded-lg px-4 py-2 text-sm font-medium shadow-xs transition-colors duration-150 ease-in-out',
        cn({
