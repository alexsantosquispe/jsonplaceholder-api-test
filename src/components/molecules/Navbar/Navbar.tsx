...
export const Navbar = () => {
  ...
  return (
    <header className="fixed z-40 flex w-full justify-center border-b border-dashed border-gray-200 bg-white/70 backdrop-blur-sm md:h-14 dark:border-white/15 dark:bg-black/50">
