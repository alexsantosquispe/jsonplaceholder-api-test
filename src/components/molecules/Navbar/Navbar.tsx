...
export const Navbar = () => {
  ...
  return (
    <header className="fixed z-50 flex w-full justify-center border-b border-b-gray-100 bg-white/60 backdrop-blur-sm md:h-[4rem] dark:border-b-white/10 dark:bg-black/50">
