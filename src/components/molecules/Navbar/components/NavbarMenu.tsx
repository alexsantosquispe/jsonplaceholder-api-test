...
export const NavbarMenu = ({ isMenuOpen, onSelectOption }: NavbarMenuProps) => {
  return (
    <div
      className={twMerge(
        'flex w-full flex-col items-start overflow-hidden text-[0.9375rem] md:flex-row md:items-center md:justify-end md:gap-x-2 md:text-black/55 dark:text-white/60',
